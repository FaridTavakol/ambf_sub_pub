...
public:
    ...
    void StateCallback(const ambf_msgs::ObjectState::ConstPtr &msg)
    {
        ...
        tau_cmd.at(3) = static_cast<float>(tau_d(3));
        tau_cmd.at(4) = static_cast<float>(tau_d(5));
        tau_cmd.at(5) = static_cast<float>(tau_d(6));
        tau_cmd.at(6) = static_cast<float>(tau_d(7));
        tau_cmd.at(7) = static_cast<float>(tau_d(8));
        tau_cmd.at(8) = static_cast<float>(tau_d(9));
