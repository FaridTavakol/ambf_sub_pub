...
VectorNd Dynamics::get_G_MTM(std::vector<double> pos)
{
    ...
    mtm_obj_.Q(2) = pos.at(7); // armparallel armparallel1
    mtm_obj_.Q(3) = pos.at(8); // armParallel1 armfront
    mtm_obj_.Q(4) = 0;         //pos.at(0);  // armfront virtual
    mtm_obj_.Q(5) = pos.at(2);
    mtm_obj_.Q(6) = pos.at(3);
    mtm_obj_.Q(7) = pos.at(4);
    mtm_obj_.Q(8) = pos.at(5);
    mtm_obj_.Q(9) = pos.at(6);
