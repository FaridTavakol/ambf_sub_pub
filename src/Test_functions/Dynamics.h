...
public:
    ...
    //methods
    unsigned int get_num_joints();                                                                                                                                                                     //Returns the degrees of freedom of the model.
    ...
    // VectorNd calc_G(const VectorNd &Q);                                                                                                                                                                //Computes the N by 1 gravity matrix of the dynamics model by equating the velocity and acceleration to zero.
